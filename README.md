...
### Download
**v1.0.1** - Compatible with Qlik Sense 1.1 to 2.2.4. [Download from GitHub](https://github.com/simeonsv/sense-alternate-states/archive/v1.0.1.zip)  
**v1.1** - Compatible with Qlik Sense 3.0. [Download from GitHub](https://github.com/simeonsv/sense-alternate-states/archive/v1.1.zip)
### Related Projects
